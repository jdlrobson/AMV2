...
class ArtworkOld {
  ...
  public static function renderArtwork($param = array(), $wikidata=true) {    
    ...
    if ($wikidata) {
      ...
      ?>
      <div class="import">
        <a href="<?php print ATLASMUSEUM_PATH; ?>Spécial:EditArtwork/<?php print $q; ?>">
    ...
    ?>
    <script type="text/javascript" src="<?php print ATLASMUSEUM_UTILS_FULL_PATH_JS; ?>artwork_old.js"></script>
    <div class="dalm">
      <div class="topCtnr">
        <?php
