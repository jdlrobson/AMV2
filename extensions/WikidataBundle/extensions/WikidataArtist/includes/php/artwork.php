...
class Artwork {
  ...
  public static function render_artists($artists) {
    ...
    foreach ($artists as $artist) {
      ...
      $text .= '<h3><span class="mw-headline" id=""><a href="" title="">' . (isset($artist_labels[$artist_id]) ? $artist_labels[$artist_id] : $artist_id) . '</a></span></h3>' . 
      '<p style="text-align:center"><a href="' . $image_url . '" class="image"><img alt="" src="' . $image_thumb . '" style="width:auto;max-width224px;max-height:149px" /></a></p>' .
  ...
  public static function render_image($claims, $property, $param, $param_name) {
    ...
    return '<div class="topImgCtnr">
      <div class="thumb tright">
        <div class="thumbinner" style="width:422px;"><a href="/wiki/Fichier:Serpentinerouge.jpg" class="image"><img alt="" src="' . $image_thumb . '" style="width:auto;max-width:420px;max-height:209px" class="thumbimage" srcset="" /></a>' . ($image_legend != '' ? '<div class="thumbcaption">' . $image_legend . '</div>' : '') .
        '</div>
      </div>
    </div>';
  }
  ...
  public static function render_other_works($id, $creators) {
    ...
    foreach($data->results->bindings as $artwork) {
      ...
      if ($artwork_id != $id) {
        ...
        $images .= '<li><div class="thumb tright"><div class="thumbinner"><a href="http://publicartmuseum.net/tmp/w/index.php?title=Spécial:Wikidata/' . $artwork_id . '" class="image"><img alt="" src="' . $image_thumb . '" style="width:auto;max-width:192px;max-height:140px" srcset=""><br />' . $title . '</a></div></div></li>';
        $n++;
      }
    }
  ...
  public static function renderArtwork($param = array(), $wikidata=true) {
    ...
    if (!is_null($param['q'])) {
      ...
      if ($wikidata)
        $edit = '<div class="import"><a href="index.php?title=Spécial:WikidataEdit/'.$q.'">
            <img src="http://publicartmuseum.net/tmp/w/skins/AtlasMuseum/resources/images/hmodify.png" />
            Importer cette œuvre dans atlasmuseum</a></div>';
      else
      $edit = '<div class="import"><a href="index.php?title=Spécial:WikidataExport/'.$_GET['title'].'"><img src="http://publicartmuseum.net/tmp/w/skins/AtlasMuseum/resources/images/hmodify.png" />Exporter cette œuvre sur Wikidata</a></div>
      <script type="text/javascript" src="http://publicartmuseum.net/tmp/w/Wikidata/js/artwork.js"></script>';

      return $edit . '<div class="dalm">
        <div class="topCtnr">' .
      ...
      <link rel="stylesheet" href="http://publicartmuseum.net/tmp/w/extensions/Wikidata/includes/artwork.css">
      ';
    } else
