...
require_once('Wikidata/php/artworkGetWikidata.php');
    ...
    ?>
      <tr>
        ...
        <td id="input_<?php print $property; ?>">
          <input id="input_<?php print $property; ?>" value="<?php print $data[$property]; ?> name="Edit[<?php print $key; ?>]">
        </td>
      </tr>
    <?
  }
...
<form id="edit_form">
  <div class="jquery-large headertabs">
    ...
    <div id="Description" class="edit_section section_unselected">
      ...
      <table class="formtable">
        <tbody>
          <?php self::render_text($data, 'P31', 'Domaine(s)', 'P31', false); ?>
          <?php self::render_item($data, 'P31', 'Domaine(s)', 'P31', false); ?>
        </tbody>
      </table>
    </div>
